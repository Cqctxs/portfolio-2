...
const MISC_APPS_SET = new Set(["terminal", "notepad", "paint"]);
const mainApps = desktopIcons.filter((icon) => !MISC_APPS_SET.has(icon.id));
const miscApps = desktopIcons.filter((icon) => MISC_APPS_SET.has(icon.id));
